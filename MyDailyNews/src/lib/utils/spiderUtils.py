...
from random import randint
from lib.core.myErrors import LoginFailError, GetPageFailError
...
class RequestsSpider():
    ...
    def get_page(self, url, session=requests):
        ...
        try:
            ...
            raise GetPageFailError
        # page warped by BeautifulSoup
        # , from_encoding="GBK")
    ...
    def get_component(self):
        '''
            获取基于BeatifulSoup页面上的一个元素
            get a component from a BeatifulSoup page
        '''
        pass
